...
namespace SpringMvc.Models.DataGenerator.Services.Implementation
{
    ...
    {
        private List<string> firstNamesMale = new List<string> { "Bryan", "William", "Andrew", "Bryan", "Harold", "Rudy", "Jess", "Michael",
                                                                 "Felipe", "Glen", "George", "Richard", "Michael", "Thomas", "Jacques", "Johnny",
                                                                 "Michael", "Anthony", "Bryan", "Juan" };

        private List<string> firstNamesFemale = new List<string> { "Krista", "Felicia", "Janice", "Katelyn", "Samantha", "Meghan", "Edwin",
                                                                   "Constance", "Jeremy", "Catherine", "Allison", "Marion", "Amanda", "Ethel",
                                                                   "Erin", "Lorene", "Julie", "Venessa", "Ruby", "Sasha" };

        private List<string> lastNames = new List<string> { "Savell", "Myers", "Miller", "Long", "Boner", "Moss", "Irving", "Fisher", "Gayman",
        ...
        private List<string> birthDates = new List<string> { "9/8/1981", "12/10/1982", "7/30/1989", "11/2/1950", "5/3/1965", "12/20/1978",
        ...
        private List<string> personalId = new List<string> { "81090859103", "82121018653", "89073067794", "50110277513", "65050372093",
        ...
        private List<string> postcodes = new List<string> { "686", "3388", "796", "2505", "1986", "777", "467", "409", "1395", "526",
        ...
        private List<string> cities = new List<string> { "Seattle", "Columbus", "Las Vegas", "Cambridge", "Montgomery", "Danbury", "Sioux Falls",
        ...
        private List<string> countries = new List<string> { "Argentina", "Australia", "Austria", "Bahamas", "Belgium", "Bosnia Herzegovina",
